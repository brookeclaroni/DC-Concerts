...
class SavedResultsAdapter (private val results: List<Result>) : RecyclerView.Adapter<SavedResultsAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(currentResult.songList[0] == null) //instead of leaving blank for 0 songs, add message
        ...
        if(currentResult.saved) //if this is a saved result, make the yellow star appear
